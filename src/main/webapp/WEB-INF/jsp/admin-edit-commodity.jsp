...
<head lang="zh-ch">
    ...
    <link rel="stylesheet" href="../../resources/css/edit-commodity.css">
</head>
<body>
<div class="header">
    <div><img src="css/images/header.gif"/></div>
</div>
<div class="navigationBack">
    <div class="navigation">
        <div class="logo">
            <a href="javascript:void(0)"><img src="css/images/logo.png"/></a>
        </div>
        ...
        <div class="link">
            ...
            <div class="image">
                <div class="commodityImage">
                    ...
                    <table>
                        <tr>
                            <td><img src="css/images/edit-commodity/desc1.png"/></td>
                            <td><img src="css/images/edit-commodity/desc2.png"/></td>
                        </tr>
                        <tr>
...
是否瑕疵：否
                ...
                <tr>
                    <td colspan="2"><div id="commodityDescriptionEffect"></div></td>
                </tr>
            </table>
        </div>
        <div class="button">
...
<script src="../../resources/js/edit-commodity.js"></script>
</html>
